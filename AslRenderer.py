...
class AslRenderer:
    ...
    def renderASL(self, tb_text):
        ...
        vlc_media_list = self.vlc_instance.media_list_new()
        position = 0
        ...
        for ii in tb_text:
            ...
            if video is not None:
                ...
                vlc_media_list.insert_media(self.vlc_instance.media_new_location(source_url),position)
                position += 1
                print(video_src)
            else:
                ...
                if result is None:
                    ...
                    if search_video is not None:
                        ...
                        vlc_media_list.insert_media(self.vlc_instance.media_new_location(sv_url),position)
                        position += 1
                        print(sv_src)
                    else:
                        print('Could not find any video on token: ' + ii)
        ...
        # Set the playlists
        self.player.set_media_list(vlc_media_list)
